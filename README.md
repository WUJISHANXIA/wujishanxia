...
WujiShanxia is an open source **enterprise social network** built with [Python][0] using the [Django Web Framework][1].
...
Try WujiShanxia now at [http://wujishanxia.com][2].
